%% Assignment/Project Script Test File : MACHINE_PATTERN_NYSEOLDDATAIROQUKINAR_001aa.m
...
% active
save(strcat(fullfile(userpathstr,projectpath,'scripts\NYSEold\'),'iroqu_kinar_active.mat'),'p2');
% absolute
save(strcat(fullfile(userpathstr,projectpath,'scripts\NYSEold\'),'iroqu_kinar_absolute.mat'),'p3')

%% 9. Print Ouput
% plot the required output
% figure;
% plotVar = {'p2.S','cumsum(transpose(squeeze(x2))-1)','p2.SH','p2.b'};
% plotTitle = {'Case : NYSEOLD_iroqukinar'};
% plotX = {'time'};
% plotY = {'S','x2','SH','b'};
% for i=1:4
%     subplot(2,2,i);
